...
<div style="display: flex; justify-content: center; align-items: center; text-align: center;">
  <a href="https://www.buaa.edu.cn/" style="margin-right: 20px; text-decoration: none; display: flex; align-items: center;">
    <img src="https://www.buaa.edu.cn/__local/B/53/A0/57D27904249F54AA06F37303250_0A1A9446_D3C7.jpg" alt="demo" style="max-width: 100px; height: auto;">
  </a>
  <div>
    <h1 style="color: #0A5C82;">高速多模态大模型</h1>
    <h3 style="margin: 0; color: #0A5C82;">北京航空航天大学</h3>
  </div>
</div>
""")
...
# 定义天蓝色主题
sky_blue_color = gr.themes.colors.Color(
    name='sky_blue',
    c50='#E6F3F9',
    c100='#C9E8F5',
    c200='#ADDCE9',
...
class Chat:
    ...
    def __init__(self, model_path, model_base, load_8bit=False, load_4bit=False):
        disable_torch_init()
...
# 使用天蓝色主题
theme = gr.themes.Default(primary_hue=sky_blue_color)
theme.set(slider_color="#0A5C82")
theme.set(block_title_text_color="#0A5C82")
theme.set(block_label_text_color="#0A5C82")
theme.set(button_primary_text_color="#0A5C82")
theme.set(button_secondary_text_color="#0A5C82")
